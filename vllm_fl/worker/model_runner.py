...
from vllm.distributed.parallel_state import (
    get_pp_group, get_tp_group, is_global_first_rank, GraphCaptureContext,
...
class AsyncGPUModelRunnerOutput(AsyncModelRunnerOutput):
    ...
    def __init__(
        ...
        self._async_copy_ready_event = current_platform.torch_device_fn.Event()
...
class ModelRunnerFL(LoRAModelRunnerMixin, KVConnectorModelRunnerMixin):
    ...
    def __init__(
        ...
        ### TODO(lms): support prepare input event
        self.prepare_inputs_event = None
        # # CUDA event to synchronize use of reused CPU tensors between steps
        # # when async scheduling is enabled.
        self.prepare_inputs_event: Optional[current_platform.torch_device_fn.Event] = None
        if self.use_async_scheduling:
            self.prepare_inputs_event = current_platform.torch_device_fn.Event()
            # Start in a completed state.
            self.prepare_inputs_event.record(current_platform.torch_device_fn.default_stream())
        ...
        self._draft_token_ids: Optional[Union[list[list[int]],
                                              torch.Tensor]] = None
        self.transfer_event = current_platform.torch_device_fn.Event()
    ...
    def _prepare_inputs(
        ...
        for kv_cache_group_id, kv_cache_group_spec in enumerate(
            ...
            for attn_group in self.attn_groups[kv_cache_group_id]:
                ...
                #### TODO(lms): support common prefix but needs know num of sms
    ...
    def load_model(self, eep_scale_up: bool = False) -> None:
        ...
        if self.compilation_config.cudagraph_mode.has_full_cudagraphs() \
            ...
            self.model = GraphWrapper(self.model,
                                          self.vllm_config,
                                          runtime_mode=CUDAGraphMode.FULL)
        ### TODO(lms): support batch wrapper

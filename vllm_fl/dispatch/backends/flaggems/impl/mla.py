...
class MLAFLImpl(MLACommonImpl[MLACommonMetadata]):
    ...
    def _forward_decode(
        ...
        o = flash_mla(q, attn_metadata.decode.block_table, kv_c_and_k_pe_cache,
                  None, PAGE_SIZE, B, 1, attn_metadata.decode.seq_lens, q_num_heads,
                  None, head_dim, head_dim_v, True)
        return o, lse

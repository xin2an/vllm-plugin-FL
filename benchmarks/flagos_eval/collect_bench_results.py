...
def extract_throughput_metrics(data):
    ...
    metrics = {
        ...
        "tokens_per_sec": data.get("tokens_per_second") or data.get("output_throughput"),
        "requests_per_sec": data.get("requests_per_second") or data.get("request_throughput"),
    }
    return metrics
...
def extract_latency_metrics(data):
    ...
    metrics = {
        ...
        "median_latency": percentiles.get("50") or data.get("median_latency") or data.get("p50_latency"),
